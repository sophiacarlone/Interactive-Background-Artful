...
Tracker::Tracker(int vidnum, bool showWindows){
	...
	vid_ = VideoCapture(vidnum);
	camera_size_vertical_   = (int)vid_.get(CAP_PROP_FRAME_HEIGHT);
	camera_size_horizontal_ = (int)vid_.get(CAP_PROP_FRAME_WIDTH );
